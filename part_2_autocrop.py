...
# Start this by typing python autocrop.py into a terminal (within activated venv).
...
def main():
    ...
    parser.add_argument("-i", metavar="INPUT_PATH", default="input/autocrop/",
                        help="Input path. Specify the folder containing the images you want be processed.")
    parser.add_argument("-o", metavar="OUTPUT_PATH", default=".",
    ...
    parser.add_argument("-c", metavar="CROP", type=int, default=5, # default=15
