...
class Splitter:
    """This utility class detects and extracts individual images from a big scanned image."""
    ...
    def split_scanned_image(cls, params: dict):
        ...
        cls.extract_contours(
            original, cnts, min_pixels, input_image_path, input_path, output_path
        )
